...
- **Competitor landscape:**
  ...
  - *Deepgram* — STT infrastructure leader; **raised $130M Series C at $1.3B valuation (Apr 2026, The SaaS News / Reuters)**. Deepgram supplies the transcription layer for several meeting intelligence products (including Fireflies.ai). While they do not currently offer a meeting intelligence product, their fresh capital increases the risk of upstack expansion into the meeting notes / transcription UI layer, potentially displacing or commoditising pure-STT approaches. Monitor product announcements closely.
...
- **New risk (May 2026):** Deepgram raised $130M Series C at $1.3B valuation (Apr 2026). As the STT infrastructure powering several meeting intelligence competitors (Fireflies.ai, etc.), Deepgram now has the capital to build or acquire meeting-layer intelligence features — turning an infrastructure vendor into a direct product competitor. The moat must be built on integrations (Slack, Notion, CRM, ATS) and post-transcription intelligence depth, not transcription accuracy alone. Speed to market with real-time action-item extraction and deep integrations is the counter-strategy.
