...
| Voice AI in Healthcare (patient-facing) | 4 | 3 | 2 | 2 | **11** | ❌ Below threshold — see voice-ai-healthcare.md; Hyro $45M raise (May 2026) validates market but confirms strong competition |
...
| Voice AI in Healthcare (patient-facing) | 11 | **⚠️ New signal (May 2026):** Hyro raised $45M (Cornell Tech) specifically for patient-facing voice AI in hospitals and health systems; validates the market but confirms well-funded competition; HIPAA compliance is still the critical-path gate — re-evaluate once HIPAA infrastructure is in place (H2 2026). See [`voice-ai-healthcare.md`](voice-ai-healthcare.md). |
...
7. **Monitor Hyro** (Voice AI in Healthcare, $45M raised May 2026, Cornell Tech). Hyro is focused on large enterprise health systems — watch whether they expand into mid-market specialty clinics. If they stay enterprise-only, the mid-market gap remains viable once HIPAA compliance infrastructure is in place. Re-score Voice AI in Healthcare (patient-facing) in H2 2026. See [`voice-ai-healthcare.md`](voice-ai-healthcare.md).
